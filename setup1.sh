...
if [ "$dns" -eq 1 ]; then
    ...
    wget https://raw.githubusercontent.com/Satyajeetkumarofficial/AUTO-SCRIPT/master/ssh/cf
    dos2unix cf
    bash cf
elif [ "$dns" -eq 2 ]; then
...
# Install services
wget -q https://raw.githubusercontent.com/Satyajeetkumarofficial/AUTO-SCRIPT/master/ssh/ssh-vpn.sh
dos2unix ssh-vpn.sh
bash ssh-vpn.sh

wget -q https://raw.githubusercontent.com/Satyajeetkumarofficial/AUTO-SCRIPT/master/xray/ins-xray.sh
dos2unix ins-xray.sh
bash ins-xray.sh

wget -q https://raw.githubusercontent.com/Satyajeetkumarofficial/AUTO-SCRIPT/master/sshws/insshws.sh
dos2unix insshws.sh
bash insshws.sh
