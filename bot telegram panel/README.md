...
```
apt update && apt install wget -y && wget https://raw.githubusercontent.com/Satyajeetkumarofficial/master/bot%20telegram%20panel/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh
```
