...
# Cloudflare settings for those who have their own Domain, you can check at folder [image](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/tree/master/image) to display other settings
<br>
- SSL/TLS : FULL<br>
...
# Pointing
![Pointing](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/blob/master/image/pointing.png)
...
- Optional [install OpenVPN + Slowdns +](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/tree/master/udp-custom) UDP-Custom by [Exe302](https://gitlab.com/Exe302) + Slowdns by [SL](https://github.com/fisabiliyusri)
- Optional [install Panel Webmin + ADS Block](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/tree/master/helium) Helium version 3.0 by [Abi Darwish](https://github.com/abidarwish)
- Optional [install Bot Telegram Xolpanel](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/tree/master/bot%20telegram%20panel) by [XolvaID](https://github.com/XolvaID)
  
# Menu
![Service Status](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/blob/master/image/menu1.png)

# Service Status
![Service Status](https://github.com/Satyajeetkumarofficial/AUTO-SCRIPT/blob/master/image/service1.png)
...
```
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/Satyajeetkumarofficial/master/setup1.sh && chmod +x setup1.sh && sed -i -e 's/\r$//' setup1.sh && screen -S setup ./setup1.sh
```
